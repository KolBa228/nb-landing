...
export const metadata: Metadata = {
    ...
    description: "Professional window cleaning, gutter cleaning, fascia cleaning in the Norwich, Norfolk and surrounding areas.",
    ...
    openGraph: {
        title: "N&B Cleaning - Professional Window Cleaning Services",
        description: "Professional window cleaning, gutter cleaning, fascia cleaning. Experience crystal clear results with our reliable services.",
